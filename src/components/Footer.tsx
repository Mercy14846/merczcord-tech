    ...
    <footer className="bg-white relative">
      <div className="container mx-auto px-6 lg:px-10 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-6 gap-10">
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="p-2 text-mercz-text-light hover:text-mercz-teal transition-colors">
              ...
              <ul className="space-y-2">
                {column.links.map((link, linkIdx) => (
                  <li key={linkIdx}>
                    <a
                      href={link.href}
                      className="text-mercz-text-light hover:text-mercz-teal transition-colors text-sm"
                    >
                      {link.name}
                    </a>
                  </li>
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex">
              <input
                ...
                className="py-2 px-3 rounded-l-md bg-mercz-neutral border border-r-0 border-gray-200 focus:outline-none focus:ring-1 focus:ring-mercz-teal text-sm flex-grow"
              />
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <button
            onClick={scrollToTop}
            className="mt-4 md:mt-0 flex items-center text-mercz-text-light hover:text-mercz-teal transition-colors"
          >
