...
const serviceItems = [
  {
    ...
    icon: <Building2 className="text-mercz-blue" size={28} />,
  },
  {
    ...
    icon: <Route className="text-mercz-blue" size={28} />,
  },
  {
...
const Services: React.FC = () => {
  return (
    <section id="services" className="section-padding bg-white relative">
      <div className="absolute inset-0 bg-mercz-blue/5 z-0"></div>
            ...
            <FadeIn key={index} delay={index * 100}>
              <GlassCard className="h-full flex flex-col">
                <div className="flex items-start mb-4">
                  <div className="p-3 rounded-md bg-mercz-blue/10 mr-4">
                    {service.icon}
                  </div>
